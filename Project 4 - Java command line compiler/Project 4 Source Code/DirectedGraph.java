...
/**
 * This is a generic class for a Directed Graph. It implements a method to initialize the graph each time a file is read in, a second method to
 * add a new edge to the graph, and a third/fourth method to generate a topological order using a dfs, given a starting index.
 * 
...
{		
	...
	/**
	 * This method will build the directed graph, using an Adjacency list. It will use the contents from the file read in to determine the directed
	 * edges of each class to another.
	 * 
	 * @param fileName the file containing the class dependency information  
	 */
	...
	/**
	 * This method will sort a starting vertex in topological order, using the depthFirstSearch method.  
	 * 
	 * @param fileName the file containing the class dependency information  
	 */
	...
	/**
	 * This method follows the depth first search pseduo code provided in the instructions, to arrange the graph in topological order using a stack. 
	 * The depthFirstSearch method algorithm generates a reverse topological order.
	 * 
	 * @param sourceIndex the vertex the dfs needs to start with.
	 * @param discovered a boolean statement to keep track of whether the vertex is already in the graph or not. 
	 * @param finished a boolean statement to keep track of whether the dfs has concluded, after it had traversed through any edges the starting vertex has.  
	 */
